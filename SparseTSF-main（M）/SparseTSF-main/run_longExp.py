...
# 设置上下文
args.use_gpu = args.use_gpu and context.get_context("device_target") == "GPU"
if args.use_gpu:
    context.set_context(mode=context.GRAPH_MODE, device_target="GPU", device_id=args.gpu)
else:
